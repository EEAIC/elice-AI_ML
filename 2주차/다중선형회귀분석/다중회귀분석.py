...
beta_0 = lrmodel.coef_[0] # 0번째 변수에 대한 기울기
beta_1 = lrmodel.coef_[1] # 1번째 변수에 대한 기울기
beta_2 = lrmodel.coef_[2] # 2번째 변수에 대한 기울기
...
def expected_sales(fb, tv, newspaper, beta_0, beta_1, beta_2, beta_3):
    ...
    '''
    return beta_0 * fb + beta_1 * tv + beta_2 * newspaper + beta_3
